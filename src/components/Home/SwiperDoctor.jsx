    ...
    <section className="py-[80px]">
      <div className="w-full h-full container mx-auto">
        ...
        <div className="text-center py-3 px-4 ">
          <h1 className="h1">
            Personalized <span className="text-red-600/80">Patient</span> Care
            Services.
          </h1>
          <hr className="max-w-[80%] m-auto" />
        </div>
        {/* swiper */}
        <div>
          {" "}
          ...
          >
            ...
            hover:border-blue-500/60 transition-all duration-300 group"
                    >
                      {/* icon */}
                      <div className="text-[60px] text-red-500 group-hover:text-blue-500 transition-all duration-500 ease-linear">
                        {item.icon}
                      </div>
                      {/* name */}
                      <div className="text-base lg:text-2xl  capitalize break-words break-all">
                        {item.name}
                      </div>
                    </div>
                  </SwiperSlide>
